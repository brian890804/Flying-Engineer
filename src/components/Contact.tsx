...
const Contact: React.FC = () => {
  ...
  const { ref: leftRef, spring: leftSpring } = useScrollAnimation({ delay: 100 });
  const { ref: rightRef, spring: rightSpring } = useScrollAnimation({ delay: 200 });
      ...
      <Container maxWidth="lg">
        ...
        <animated.div ref={headerRef} style={headerSpring}>
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
            ...
            />
            <Typography sx={{ color: 'rgba(250,247,244,0.7)', maxWidth: 480, mx: 'auto', lineHeight: 1.8 }}>
        ...
        >
          ...
          <animated.div ref={rightRef} style={rightSpring}>
            ...
            >
              <Typography
                variant="h5"
                sx={{ color: '#FAF7F4', fontWeight: 700, mb: 1, fontSize: '1.15rem' }}
              >
                服務地區
              </Typography>
              <Typography sx={{ color: 'rgba(250,247,244,0.6)', fontSize: '0.88rem', mb: 3, lineHeight: 1.7 }}>
              ...
              <Box
                sx={{
                  p: 3,
                  borderRadius: 2,
                  background: 'linear-gradient(135deg, #7B5035 0%, #A0704F 100%)',
                  textAlign: 'center',
                }}
              >
                <Typography sx={{ color: '#FAF7F4', fontSize: '0.85rem', mb: 1 }}>
                  立即來電免費估價
                </Typography>
                <Typography
                  sx={{
                ...
                <Typography sx={{ color: 'rgba(250,247,244,0.7)', fontSize: '0.8rem', mt: 0.5 }}>
                  週一至週六 08:00 – 18:00
                </Typography>
              </Box>
            </Paper>
