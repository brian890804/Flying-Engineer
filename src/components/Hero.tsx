    ...
    <animated.div style={bgSpring}>
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ maxWidth: 720 }}>
            ...
            <animated.div style={trail[2]}>
              ...
              >
                超過十年深耕北北基桃地區，從牆面到地坪，從廚衛到外牆，
                提供細緻精準的泥作工藝，讓每個空間煥然一新。
              </Typography>
            </animated.div>
        ...
        <Box
          ...
          onClick={() => scrollTo('services')}
        >
          <Typography sx={{ color: 'rgba(250,247,244,0.5)', fontSize: '0.75rem', mb: 0.5 }}>
            向下滑動
          </Typography>
          <KeyboardArrowDownIcon sx={{ color: 'rgba(250,247,244,0.5)', fontSize: 28 }} />
        </Box>
      </Box>
    </animated.div>
  );
